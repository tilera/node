...
# elif (defined(_M_X64) || defined(__x86_64__) || defined(__tilegx__)) && !defined(_WIN32)
...
# undef DES_LONG
# if defined(_M_X64) || defined(__x86_64__) || defined(__tilegx__) || defined(__arm__) || defined(__mips__)
